        ...
        <div class="stats-breakdown-grid">
            ...
            <div>
                <div class="stats-summary-total">
                    ...
                    <span class="stats-summary-value">{{ array_sum($stats) }}</span>
                </div>
                ...
                <div class="stats-breakdown-item stats-breakdown-free">
                    ...
                    <div class="stats-breakdown-percentage">{{ round($stats['free'] / max(array_sum($stats), 1) * 100, 1) }}% of users</div>
                </div>
                ...
                <div class="stats-breakdown-item stats-breakdown-starter">
                    ...
                    <div class="stats-breakdown-percentage">{{ round($stats['starter'] / max(array_sum($stats), 1) * 100, 1) }}% of users</div>
                </div>
            </div>
            ...
            <div>
                <div class="stats-breakdown-item stats-breakdown-professional">
                    ...
                    <div class="stats-breakdown-percentage">{{ round($stats['professional'] / max(array_sum($stats), 1) * 100, 1) }}% of users</div>
                </div>
                ...
                <div class="stats-breakdown-item stats-breakdown-enterprise">
                    ...
                    <div class="stats-breakdown-percentage">{{ round($stats['enterprise'] / max(array_sum($stats), 1) * 100, 1) }}% of users</div>
                </div>
            </div>
        </div>
            ...
            @foreach ($stats as $planName => $count)
                <div class="stats-distribution-bar">
                    <div class="stats-distribution-label">
                        <span class="stats-distribution-name">{{ ucfirst($planName) }}</span>
